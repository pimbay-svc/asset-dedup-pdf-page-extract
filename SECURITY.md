...
Use [GitHub Security Advisories](https://github.com/pimbay-svc/asset-dedup-pdf-page-extract/security/advisories/new) for this repository, or email **security@pimbay.dev**.
...
Out of scope: vulnerabilities in third-party dependencies with no `asset-dedup-pdf-page-extract`-specific exploitation path — report those upstream instead (see `docs/THIRD-PARTY-NOTICES.md` for what's bundled).
